...
import { SectionTitleType, ProductType, ProductNftBoxType } from "@utils/types";
                            ...
                            {state.products.slice(0, 10).map((prod) => (
                                ...
                                >
                                    <NFTBox
                                        ...
                                        marketplaceAddress={
                                            prod.marketplaceAddress
                                        }
                                        seller={prod.seller}
                                        key={`${prod.nftAddress}${prod.tokenId}`}
                                        overlay
...
ExploreProductArea.propTypes = {
    ...
    data: PropTypes.shape({
        ...
        products: PropTypes.arrayOf(ProductNftBoxType),
